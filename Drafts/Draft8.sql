...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2022 at 05:46 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `uspInsertPaymentCard` (IN `CardLongNum` TEXT, IN `CardExpiryDate` DATE, IN `BookingContactId` INT, IN `CardVendorId` INT)   BEGIN
    ...
    SET CardExpirySaltedHash = SHA1(CONCAT(CardExpirySalt, CardExpiryDate));
...
INSERT INTO `booking` (`booking_id`, `booking_reference`, `booking_made_utc_datetime`, `total_cost_gbp`, `booking_contact_id`, `return_flight_id`, `outbound_flight_id`) VALUES
(1, 'BR1', '2022-10-30 15:26:25', '123.0000', 1, 9, 1);
...
INSERT INTO `room_booking` (`room_booking_id`, `room_booking_room_type_id`, `room_booking_booking_id`) VALUES
(1, 1, 1),
(2, 1, 1),
(3, 3, 1);
...
(1, 'Double or Twin room', NULL, 2, 2, NULL, 10, 11),
(2, 'Double or Twin room - Sleeps up to 3', NULL, 2, 3, NULL, 5, 11),
(3, 'Double or Twin room with Pool room', NULL, 2, 3, NULL, 6, 11),
(4, 'Single Room Basic', NULL, 1, 1, 1, 15, 12),
(5, 'Single Room Fancy', NULL, 1, 1, NULL, 2, 12),
(6, 'Double King Room Mega 9000', NULL, 2, 2, 2, 3, 12),
(7, 'Uber Mega Fancy Business Suite', NULL, 1, 2, NULL, 3, 13),
...
(47, '12.1000', '2023-01-02 12:00:01', '2023-01-02 18:00:00', 8),
(48, '566.6500', '2023-01-02 18:00:00', '2023-01-02 23:59:59', 8);
...
ALTER TABLE `review`
  ...
  ADD KEY `FK__hotel__hotel_id_10` (`review_hotel_id`);
...
--
ALTER TABLE `booking_contact`
  MODIFY `booking_contact_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `booking_contact_telephone`
--
ALTER TABLE `booking_contact_telephone`
  MODIFY `booking_contact_telephone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `booking_passenger`
--
ALTER TABLE `booking_passenger`
  MODIFY `booking_passenger_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `payment_card`
  MODIFY `payment_card_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `room_booking`
  MODIFY `room_booking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `room_type`
  MODIFY `room_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `route_price`
  MODIFY `route_price_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
ALTER TABLE `review`
  ...
  ADD CONSTRAINT `FK__hotel__hotel_id_10` FOREIGN KEY (`review_hotel_id`) REFERENCES `hotel` (`hotel_id`),
