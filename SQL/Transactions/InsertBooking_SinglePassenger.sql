START TRANSACTION;
    ...
    ********************************/
    ...
    INSERT INTO telephone (telephone.telephone_number, telephone.telephone_type_id) VALUES ('34562134', @TelephoneTypeHomeOfficeId);
    SET @Telephone1 = LAST_INSERT_ID();

    INSERT INTO telephone (telephone.telephone_number, telephone.telephone_type_id) VALUES ('+44 12342134', @TelephoneTypeMobileId);
    SET @Telephone2 = LAST_INSERT_ID();

    INSERT INTO telephone (telephone.telephone_number, telephone.telephone_type_id) VALUES ('0-1234-emergency', @TelephoneTypeEmergencyId);
    ...
    VALUES (AES_ENCRYPT('6548965712858741', @PaymentCardSecret), AES_ENCRYPT('2035-02-20', @PaymentCardSecret), @BookingContactId, @CardVendorId);
    ...
    ********************************/
    ...
    VALUES ('placeholder review please ignore', @BookingContactId, @ReviewRatingId);
    ...
    ********************************/
    ...
    VALUES ('3', @BookingId, @PaymentCardId);
